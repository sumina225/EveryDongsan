            ...
            <div class="step step1">
                <div class="membership">
                    ...
                    <dl>
                        <dt>제목</dt>
                        <dd>
                            <input v-model="form.title" type="text" placeholder="게시물 이름을 입력해주세요.(눈에 띄는)"
                                autocomplete="off" />
                        </dd>
                    </dl>
                    ...
                    <dl>
                        <dt>학교</dt>
                        <dd @click="openModal">
                            <input v-model="form.home.school" type="text" readonly="readonly" placeholder="학교를 선택하세요."
                    ...
                    <dl>
                        <dt>매물 이름</dt>
                        <dd>
                            <input v-model="form.home.name" type="text" placeholder="집 이름을 입력하세요." autocomplete="off" />
                        </dd>
                    </dl>
                    <dl>
                        <dt>위도</dt>
                        <dd>
                            <input v-model="form.home.latitude" type="text" placeholder="위도를 입력하세요."
                                autocomplete="off" />
                        </dd>
                    </dl>
                    <dl>
                        <dt>경도</dt>
                        <dd>
                            <input v-model="form.home.longitude" type="text" placeholder="경도를 입력하세요."
                                autocomplete="off" />
                        </dd>
                    </dl>
                    <dl>
                    ...
                    <dl>
                        <dt>면적</dt>
                        <dd>
                            <input v-model="form.home.area" type="text" placeholder="면적을 입력하세요.(m²)"
                                autocomplete="off" />
                        </dd>
                    </dl>
                    ...
                    <dl class="radio_select">
                        ...
                        <dd>
                            <div>
                                <input type="radio" id="rentalType_jeonse" name="rentalType" value="전세"
                                    v-model="rentalType" />
                            ...
                            <div>
                                <input type="radio" id="rentalType_monthly" name="rentalType" value="월세"
                                    v-model="rentalType" />
...
const submitPost = async () => {
    const addPost = usePostStore(); // Pinia 스토어 연결
    ...
    // Pinia 스토어를 통해 서버 요청
    const result = await addPost.submitPost(postData);
