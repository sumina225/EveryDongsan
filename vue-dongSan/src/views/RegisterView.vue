          ...
          <dl>
            ...
            <dd>
              <textarea
                ...
                placeholder="매물 설명 및 내용을 간단하게 입력하세요."
              ></textarea>
            </dd>
          </dl>
          ...
          <dl>
            ...
            <dd>
              <input
                ...
                @input="truncateToFiveDecimal('latitude')"
                type="text"
          ...
          <dl>
            ...
            <dd>
              <input
                ...
                @input="truncateToFiveDecimal('longitude')"
                type="text"
...
const filteredSchools = computed(() => {
  if (!searchQuery.value.trim()) {
    return schoolStore.schoolList.slice(0, 5);
  }
...
const truncateToFiveDecimal = (field) => {
  if (form.value.home[field]) {
    // 숫자인 경우 소수점 이하 5자리까지 자르기
    const match = form.value.home[field].toString().match(/^(\d+\.?\d{0,5})/);
    form.value.home[field] = match ? match[1] : form.value.home[field];
  }
};
